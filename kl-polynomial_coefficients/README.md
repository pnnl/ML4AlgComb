...
If $v = 0\;2\;1\;3\;5\;4\;6\;9\;7\;8$ and $w=2\;3\;0\;5\;9\;6\;7\;8\;1\;4$ then
\begin{equation*}
P_{v,w}(q) = 4q^4+12q^3+13q^2+6q+1.
\end{equation*}
and this is written as the line
\begin{verbatim}
...
\begin{itemize}
\item \begin{verbatim}processed_S5_train.txt \end{verbatim}
\item \begin{verbatim}processed_S6_test.txt \end{verbatim}
\end{itemize}
